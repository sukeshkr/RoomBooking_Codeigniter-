...
<section class="content">
    ...
    <div class="box box-primary">
        ...
        <!-- /.box-header -->
           ...
           <form role="form" name="addform" method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>service/create" onSubmit="return validForm()">
                                    <div class="row">

                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Service name</label>
                                                <input type="text"  maxlength="50" id="service" class="form-control" name="service" value="<?php echo set_value('service'); ?>">
                                                 <?php echo form_error('service', '<p class="help-block error-info">', '</p>'); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Rate(Rs)</label>
                                                <input type="number"  maxlength="50" id="rate" class="form-control" name="rate" value="<?php echo set_value('rate'); ?>"  min="0" step="1">
...
<script>
  ...
  $("#cancel").click(function () {//jquery cancel function when cancel button click
    window.location = '<?= CUSTOM_BASE_URL . "service" ?>';
  });

...
<section class="content">
    ...
    <form  role="form" name="addform" method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>service/update " onsubmit="return valid();"> 
                                    ...
                                    <div class="row">
                                          ...
                                          <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Rate</label>
                                                    <textarea class="form-control" rows="3" name="rate"><?php echo $row->rate; ?></textarea>

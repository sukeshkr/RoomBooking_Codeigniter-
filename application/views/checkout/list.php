...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#Extendmodal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo site_url('Check_out/ExtendCheckin'); ?>',
                data: 'rowid=' + rowid,
                success: function (data) {
                    $('.extend-modal').html(data);
                }
            });
        });
    });
    ...
    $(document).ready(function () {
        ...
        $('#view-modal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo site_url('Check_out/ServiceCharge'); ?>',
                data: 'rowid=' + rowid,
                success: function (data) {
   ...
   <script>
    ...
    $(document).ready(function () {
        ...
        $('#checkout-modal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo site_url('Check_out/checkOutRoom'); ?>',
                data: 'rowid=' + rowid,
                success: function (data) {
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#del-modal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo site_url('Check_out/delete'); ?>',
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        "ajax": {
        "url": '<?php echo site_url('Check_out/type_list'); ?>',
        "type": "POST",
        },

          ...
          <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-header">
                  <a class="btn bg-olive" href="<?php echo base_url() ?>daybook/create"><span class="glyphicon glyphicon-plus-sign"></span> Create</a>
 ...
 <script>
    ...
    $(document).ready(function () {
        ...
        $('#view-modal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo site_url('Daybook/view'); ?>',
                data: 'rowid=' + rowid,
 ...
 <script>
    ...
    $(document).ready(function () {
        ...
        $('#payment-modal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo site_url('Daybook/payment'); ?>',
                data: 'rowid=' + rowid,
                success: function (data) {
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#del-modal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo site_url('Daybook/delete'); ?>',
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        "ajax": {
        "url": '<?php echo site_url('Daybook/daybook_list'); ?>',
        "type": "POST",
        },

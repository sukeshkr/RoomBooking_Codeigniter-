          ...
          <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-header">
                  <a class="btn bg-olive" href="<?php echo base_url() ?>facility/create"><span class="glyphicon glyphicon-plus-sign"></span> Create</a>
...
<!-- /.content -->
    ...
    $(document).ready(function () {
        ...
        $('#view-modal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo site_url('Booking_type/view'); ?>',
                data: 'rowid=' + rowid,
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#del-modal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo site_url('Booking_type/delete'); ?>',
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        "ajax": {
        "url": '<?php echo site_url('Booking_type/type_list'); ?>',
        "type": "POST",
        },

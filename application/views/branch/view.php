                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a href="<?= CUSTOM_BASE_URL .'branch/create'?>" class="btn btn-success">Create</a>
                            </div>
                                    ...
                                    <?php foreach ($profile as $row) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               <a class="btn btn-warning" href="<?= CUSTOM_BASE_URL.'Branch/edit/'.$row['id'];?>"><i class="fa fa-edit" aria-hidden="true"></i></a>
...
<!-- /.content -->
    ...
    $(document).ready(function () {
        ...
        var rowid = $(e.relatedTarget).data('id');
            $.ajax({
                type: 'post',
                url: '<?php echo site_url('Branch/delete'); ?>', //Here you will fetch records 

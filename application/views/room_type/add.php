                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"  maxlength="50" id="type_name" class="form-control" name="type_name" value="<?php echo set_value('type_name'); ?>">
                                                 <?php echo form_error('type_name', '<p class="help-block error-info">', '</p>'); ?>

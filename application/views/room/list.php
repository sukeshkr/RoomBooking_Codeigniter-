          ...
          <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-header">
                  <a class="btn bg-olive" href="<?php echo base_url() ?>room/create"><span class="glyphicon glyphicon-plus-sign"></span> Create</a>
...
<!-- /.content -->
    ...
    $(document).ready(function () {
        ...
        $('#view-modal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo site_url('Room/view'); ?>',
                data: 'rowid=' + rowid,
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        "ajax": {
        "url": '<?php echo site_url('Room/room_list'); ?>',
        "type": "POST",
        },

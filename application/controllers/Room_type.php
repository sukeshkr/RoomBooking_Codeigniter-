...
class Room_type extends MY_Auth_Controller {

    public function __construct() {
        parent::__construct();

        $this->load->model('Room_type_model','model');
    ...
    public function type_list(){
        ...
        <a href="room_type/edit/'.$types->id.'" class="btn  btn-warning" href="#"><i class="fa fa-edit" aria-hidden="true"></i></a>
    ...
    public function view() {
        ...
        $data['room_type'] = $this->model->viewData($id);
        $this->load->view('room_type/view', $data);
    }
    ...
    public function delete() {
        ...
        $this->load->view('room_type/delete');
